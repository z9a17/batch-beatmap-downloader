    ...
    <article className="border-t border-line last:border-b">
      <div className="flex items-center gap-4 p-5">
        ...
        <div className="min-w-[170px]">
          ...
          <div className="mt-1 truncate text-xs text-faint">Job {status.id.slice(0, 8)}</div>
        </div>
        ...
        <button
          className="flex h-9 w-9 items-center justify-center text-dim transition hover:bg-white/[0.04] hover:text-ink"
