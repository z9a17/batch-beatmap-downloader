  ...
  return (
    <div className="border-y border-line">
      <div className="border-b border-line py-5">
        ...
        />
        <div className="mt-2 text-[13px] leading-5 text-faint">Changes here stay synchronized with the visual controls below.</div>
      </div>

      <div className="grid grid-cols-[190px_minmax(0,1fr)]">
        <div className="border-r border-line py-4 pr-4">
          <div className="mb-2 px-2 text-xs font-bold uppercase tracking-[0.12em] text-faint">Filter groups</div>
          {sections.map(item => (
            <button
              key={item.title}
        ...
        <div className="py-5 pl-6">
          ...
          <div className="mb-3 flex items-center justify-between border-t border-line pt-5">
            <div>
              ...
              <div className="mt-1 text-[13px] leading-5 text-faint">Only adjusted values become active rules.</div>
            </div>
          </div>
