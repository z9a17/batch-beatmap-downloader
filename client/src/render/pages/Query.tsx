    ...
    <div className="page-stack">
      {showCompatibilityModal && document.getElementById("modal") && createPortal(
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-8">
          <div className="w-full max-w-lg rounded-2xl border border-strong bg-panel-2 p-7 shadow-2xl shadow-black/50">
            <h3 className="mt-2 text-xl font-semibold text-ink">Flatten this advanced query?</h3>
      ...
      {result && result.beatmaps === 0 && (
        <div className="flat-empty min-h-[180px] text-dim">
          ...
          <section className="content-box no-pad">
            <div className="border-b border-line px-6 py-5">
              <div className="mt-1 flex items-baseline justify-between">
                ...
                <span className="text-[13px] text-faint">{result.beatmaps.toLocaleString()} difficulties</span>
              </div>
            </div>
